...
``FeNiCo_db_2.xlsx`` & ``FeNiCo_db_2.csv`` : Main database of FeNiCo alloys collected from literature

``FeNiCo_comp-prop.xlsx`` & ``FeNiCo_comp-prop.csv`` : Database of composition and selected properties used from main database in this study
